...
{
	static ArrayList<BookIssueDetails> bookIssueDetails=new ArrayList<BookIssueDetails>();
	static HashMap<Integer,Book> bookList=new HashMap<Integer,Book>();
	static HashMap<Integer,Student> studentList=new HashMap<Integer,Student>();
	public void addBook()
	{
		Book b=new Book();
